...
struct handler code_keys[KEY_MAX - KEY_MIN + 1] = {
	...
	[KEY_F(1) - KEY_MIN]       = { { .a = passthru }, "\x01\033" },
	[KEY_F(2) - KEY_MIN]       = { { .a = passthru }, "\x03\033OQ" },
	[KEY_F(3) - KEY_MIN]       = { { .a = passthru }, "\x03\033OR" },
	[KEY_F(4) - KEY_MIN]       = { { .a = passthru }, "\x03\033OS" },
	[KEY_F(5) - KEY_MIN]       = { { .a = passthru }, "\x05\033[15~" },
	[KEY_F(6) - KEY_MIN]       = { { .a = passthru }, "\x05\033[17~" },
	[KEY_F(7) - KEY_MIN]       = { { .a = passthru }, "\x05\033[18~" },
	[KEY_F(8) - KEY_MIN]       = { { .a = passthru }, "\x05\033[19~" },
	[KEY_F(9) - KEY_MIN]       = { { .a = passthru }, "\x05\033[20~" },
	[KEY_F(10) - KEY_MIN]      = { { .a = passthru }, "\x05\033[21~" },
	[KEY_F(11) - KEY_MIN]      = { { .a = passthru }, "\x05\033[23~" },
	[KEY_F(12) - KEY_MIN]      = { { .a = passthru }, "\x05\033[24~" },
	[KEY_HOME - KEY_MIN]       = { { .a = passthru }, "\x04\033[1~" },
	[KEY_END - KEY_MIN]        = { { .a = passthru }, "\x04\033[4~" },
	[KEY_PPAGE - KEY_MIN]      = { { .a = passthru }, "\x04\033[5~" },
	[KEY_NPAGE - KEY_MIN]      = { { .a = passthru }, "\x04\033[6~" },
	[KEY_BACKSPACE - KEY_MIN]  = { { .a = passthru }, "\x01\177" },
